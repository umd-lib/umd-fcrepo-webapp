...
import edu.umd.lib.fcrepo.services.LdapRoleLookupService;
...
import static edu.umd.lib.fcrepo.filters.FedoraRolesFilter.ADMIN_ROLE;
import static edu.umd.lib.fcrepo.filters.FedoraRolesFilter.SESSION_ROLE_KEY;
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    ...
    if (authorizationHeader != null && authorizationHeader.startsWith("Bearer")) {
      ...
      try {
        ...
        final Claims tokenBody = jws.getPayload();
